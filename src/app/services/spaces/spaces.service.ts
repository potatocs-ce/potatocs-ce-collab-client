...
export class SpacesService {
  ...
  deleteSpace(spaceTime) {
    return this.http.delete(this.baseUrl + '/collab/space/deleteSpace', {
      params: spaceTime,
    });
  }
  ...
  changeSpaceName(data) {
    return this.http.put(
      this.baseUrl + '/collab/space/change-space-name',
      data
    );
  }
  ...
  searchSpaceMember(email) {
    return this.http.get(this.baseUrl + '/collab/searchSpaceMember', {
      params: email,
    });
  }
  ...
  addSpaceLabel(data) {
    return this.http
      .put(this.baseUrl + '/collab/add-space-label', data)
      .subscribe((res: any) => {
  ...
  deleteSpaceLabel(data) {
    return this.http
      .put(this.baseUrl + '/collab/delete-space-label', data)
      .pipe(
        tap(async (res: any) => {
